...
import { verifyAttendance } from "./api"; // Make sure to copy your api.js file to the same folder
import {
  Camera,
  MapPin,
  UserCheck,
...
const AttendanceMarking = () => {
  ...
  return (
    <div className="attendance-marking-wrapper">
      <motion.div
            ...
            <div className="status-card">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  {status === "success" && (
                    <UserCheck size={48} className="text-success" />
                  )}
                  {status === "rejected" && (
